...
This file tracks the top-K recently accessed files under `templates/` and all descendants.
...
| `wiki-page-template.md` | Template for generated wiki pages. | create | Defines source-backed wiki page sections. | 2026-04-19 |
